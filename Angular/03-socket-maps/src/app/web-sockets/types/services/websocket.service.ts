...
import { Client, LatLng } from '../../../types/index';
...
export class WebSocketService {
  ...
  constructor() {
    if ( Cookies.get('name') && Cookies.get('color') && Cookies.get('coords')) this.connectWebSocket();
  ...
  private connectWebSocket() {
    ...
    this.socket.addEventListener('message', (event) => {
      ...
      if ( data.type === 'WELCOME' ) this.client.set(data.payload);
